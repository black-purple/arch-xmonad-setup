...
case ${TERM} in
	xterm*|rxvt*|Eterm*|aterm|kterm|alacritty|kitty|st|gnome*|interix|konsole*)
...
# export PS1="\[\e[31m\][\[\e[m\]\[\e[33m\]\u\[\e[32m\]@\[\e[34m\]\h\[\e[m\] \[\e[35m\]\W\[\e[m\]\[\e[31m\]]\[\e[m \]\\$ "
export PATH=$PATH:~/flutter/bin:~/dls/android-studio/bin/
